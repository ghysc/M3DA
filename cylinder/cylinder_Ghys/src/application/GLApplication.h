...
public:
  ...
  p3d::Vector3 tangentPathCircle(unsigned int i);

  p3d::Vector3 pointSpline(double tNormalized);
  p3d::Vector3 tangentPathSpline(double tNormalized, bool isRevolution);

  void extrudeLine(bool isRevolution);
  void extrudeSpline(bool isRevolution);
  void buildExtrusion(bool isRevolution);
